<template>
	<Disclosure as="nav" class="bg-gray-800" v-slot="{ open }">
		<div class="container xl:max-w-6xl mx-auto px-2 sm:px-6 lg:px-0">
			<div class="relative flex h-16 items-center justify-between">
				...
				<div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
					<div class="flex flex-shrink-0 items-center">
						<img class="h-8 w-auto" src="/favicon.webp"
							alt="Your Company" />
					</div>
					...
					<Menu as="div" class="relative ml-3">
						...
						<transition enter-active-class="transition ease-out duration-100"
							...
							<MenuItems
								...
								<MenuItem v-slot="{ active }">
								<div href="#"
									:class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']">Settings
								</div>
								</MenuItem>
								<MenuItem v-slot="{ active }">
								<div href="#"
...
const navigation = [
	{ name: 'Agendamento', href: '#', current: true },
